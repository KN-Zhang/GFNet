...
if __name__ == "__main__":
    ...
    if args.dataset == 'mscoco':
        test_path = f'{gfnet_configs.cfg.DATA_PATH}/test/mscoco_1k_448x448/source'
        ext = 'png'
    elif args.dataset == 'vis_ir_drone':
        test_path = f'{gfnet_configs.cfg.DATA_PATH}/test/visir_1k_448x448/source'
        ext = 'png'
    elif args.dataset == 'googlemap_448x448':
        test_path = f'{gfnet_configs.cfg.DATA_PATH}/test/googlemap_1k_448x448_new/source'
        ext = 'jpg'
    elif args.dataset == 'googlemap_224x224':
        test_path = f'{gfnet_configs.cfg.DATA_PATH}/test/googlemap_1k_224x224_new/source'        
        ext = 'jpg'
    elif args.dataset == 'googlemap_672x672':
        test_path = f'{gfnet_configs.cfg.DATA_PATH}/test/googlemap_1k_672x672/source'        
        ext = 'jpg'    
